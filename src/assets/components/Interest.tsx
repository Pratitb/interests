...
const Interest: React.FC<InterestProps> = ({ label, selected, getInterestFn }) => {
    return (
        <div className={`bg-grayDrk rounded-xl flex items-center py-1 pr-4 pl-2 border cursor-pointer ${selected ? 'border-green-500' : ' border-transparent'}`} onClick={getInterestFn}>
